        ...
        <div className="pulse-rise mb-4 overflow-hidden rounded-[30px] border border-white/70 bg-white/80 shadow-[0_24px_70px_rgba(20,20,24,0.1)] backdrop-blur">
          <div className="grid gap-5 p-5 lg:grid-cols-[1fr_auto] lg:items-center">
            <div className="min-w-0">
              <div className="mb-3 inline-flex items-center gap-2 rounded-full bg-[#f7f7f8] px-3 py-1.5 text-[10px] font-normal uppercase tracking-[0.14em] text-pulse-muted">
                <Brain className="h-3.5 w-3.5 text-[#7f7cff]" />
                Trends dashboard
              </div>
              <div className="flex flex-wrap items-center gap-3">
                <h1 className="text-4xl font-normal leading-none tracking-normal text-pulse-ink">
                  Health Trends
                </h1>
                <span className="inline-flex items-center gap-1.5 rounded-full bg-pulse-green px-3 py-1.5 text-[10px] font-normal text-pulse-ink shadow-sm">
                  <span className="h-2 w-2 rounded-full bg-pulse-ink animate-pulse" />
                  LIVE
                </span>
              </div>
              <p className="mt-2 max-w-2xl text-sm font-normal leading-6 text-pulse-muted">
            ...
            <div className="flex flex-wrap items-center justify-start gap-2 lg:justify-end">
              {[
                ...
                <div
                  className={`pulse-float-slow rounded-[18px] border border-white/75 px-4 py-2 text-xs font-normal shadow-sm ${stat.tone}`}
                  key={stat.label}
                >
              ...
              <button
                onClick={handleSync}
                disabled={isSyncing}
                className="pulse-sheen flex cursor-pointer items-center gap-2 rounded-full bg-pulse-ink px-5 py-3 text-xs font-normal text-white shadow-sm transition hover:-translate-y-0.5 disabled:cursor-not-allowed disabled:opacity-50"
              >
        ...
        <div className="relative flex-1">
          {!hasData && (
            <div className="absolute inset-0 z-30 flex flex-col items-center justify-center rounded-[24px] bg-white/40 backdrop-blur-[6px] border border-dashed border-pulse-line p-6 text-center select-none">
              ...
              <h2 className="text-xl font-normal text-pulse-ink mb-1">
              ...
              <button
                onClick={handleSync}
                disabled={isSyncing}
                className="flex items-center gap-2 rounded-full bg-pulse-ink text-white px-5 py-3 text-sm font-normal transition hover:bg-pulse-ink/80 cursor-pointer shadow-pulse"
              >
            ...
            <Card className="pulse-rise-delay overflow-hidden bg-white/88 xl:col-span-2">
              ...
              <CardBody className="p-5">
                <div className="relative h-52 overflow-hidden rounded-[24px] border border-pulse-line/70 bg-gradient-to-b from-pulse-mint/45 via-white to-white px-1 pt-4 shadow-inner">
                  <div className="absolute left-6 top-5 rounded-full bg-white/80 px-3 py-1 text-[10px] font-normal uppercase tracking-[0.12em] text-pulse-muted shadow-sm">
                    live pulse stream
                  </div>
                ...
                <div className="mt-3 flex justify-between text-[10px] font-normal uppercase tracking-wider text-pulse-muted">
                  <span>Log Start</span>
              ...
              <CardBody className="flex h-[258px] flex-col justify-end p-5">
                <div className="grid flex-1 grid-cols-3 items-end gap-3 rounded-[22px] bg-white/40 p-4">
                  <div className="flex flex-col items-center">
                    <span className="mb-1 text-xs font-normal text-pulse-ink">{hasData ? stressLow : 0}</span>
                    <div
                    ...
                    />
                    <span className="mt-2 text-[10px] font-normal uppercase tracking-wider text-pulse-muted">Low</span>
                  </div>
                  <div className="flex flex-col items-center">
                    <span className="mb-1 text-xs font-normal text-pulse-ink">{hasData ? stressFair : 0}</span>
                    <div
                    ...
                    />
                    <span className="mt-2 text-[10px] font-normal uppercase tracking-wider text-pulse-muted">Fair</span>
                  </div>
                  <div className="flex flex-col items-center">
                    <span className="mb-1 text-xs font-normal text-pulse-ink">{hasData ? stressHigh : 0}</span>
                    <div
                    ...
                    />
                    <span className="mt-2 text-[10px] font-normal uppercase tracking-wider text-pulse-muted">High</span>
                  </div>
                </div>
              </CardBody>
            </Card>
                ...
                <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-1 2xl:grid-cols-2">
                  <div className="group flex items-center gap-3 rounded-[18px] bg-white/75 p-3 shadow-sm transition hover:-translate-y-1">
                    <div className="relative flex h-16 w-16 shrink-0 items-center justify-center">
                      ...
                      <span className="text-xs font-normal text-pulse-ink">{avgSleepScore}%</span>
                    </div>
                    <div>
                      <p className="text-sm font-normal text-pulse-ink">This Sync</p>
                  ...
                  <div className="group flex items-center gap-3 rounded-[18px] bg-white/75 p-3 shadow-sm transition hover:-translate-y-1">
                    <div className="relative flex h-16 w-16 shrink-0 items-center justify-center">
                      ...
                      <span className="text-xs font-normal text-pulse-ink">{prevSleepScore}%</span>
                    </div>
                    <div>
                      <p className="text-sm font-normal text-pulse-ink">Prior Log</p>
            ...
            <Card className="pulse-rise bg-[#e9f9d9]/95">
              ...
              <CardBody className="flex min-h-[144px] items-center gap-5 p-4">
                <div className="relative flex h-24 w-24 shrink-0 items-center justify-center">
                  ...
                  <span className="text-base font-normal text-pulse-ink">{avgSpO2}%</span>
                </div>
                <div>
                  <p className="text-sm font-normal text-pulse-ink">Oxygen Saturation</p>
                  <p className="mt-1 text-xs font-normal leading-5 text-pulse-muted">
                    Stable respiratory signal from the latest wearable sync.
                  </p>
                  <span className="mt-3 inline-flex rounded-full bg-white/75 px-3 py-1 text-[10px] font-normal uppercase tracking-[0.12em] text-pulse-muted">
              ...
              <CardBody className="p-5">
                <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
                  <div className="rounded-[18px] bg-[#f7f7f8] p-4 shadow-sm transition hover:-translate-y-1">
                    <span className="text-xs font-normal uppercase tracking-wider text-pulse-muted block">Steps</span>
                    <div className="flex items-center gap-1 mt-1">
                      <Navigation className="h-4.5 w-4.5 text-pulse-ink rotate-45" />
                      <span className="text-xl font-normal text-pulse-ink">{avgSteps.toLocaleString()}</span>
                    </div>
                  </div>

                  <div className="rounded-[18px] bg-[#fff6cc] p-4 shadow-sm transition hover:-translate-y-1">
                    <span className="text-xs font-normal uppercase tracking-wider text-pulse-muted block">Burn Rate</span>
                    <div className="flex items-center gap-1 mt-1">
                      <Flame className="h-4.5 w-4.5 text-orange-400" />
                      <span className="text-xl font-normal text-pulse-ink">{avgCalories} kcal</span>
                    </div>
                  </div>

                  <div className="rounded-[18px] bg-[#f2f1ff] p-4 shadow-sm transition hover:-translate-y-1">
                    <span className="text-xs font-normal uppercase tracking-wider text-pulse-muted block">Distance</span>
                    <span className="text-xl font-normal text-pulse-ink mt-1 block">{totalDistance} km</span>
                  </div>

                  <div className="rounded-[18px] bg-[#e9f9d9] p-4 shadow-sm transition hover:-translate-y-1">
                    <span className="text-xs font-normal uppercase tracking-wider text-pulse-muted block">Active Zones</span>
                    <div className="flex items-center gap-1 mt-1">
                      <Zap className="h-4.5 w-4.5 text-pulse-green" />
                      <span className="text-xl font-normal text-pulse-ink">{avgActiveMins} min</span>
                    </div>
                  </div>
                </div>
